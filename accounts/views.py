...
def register(request):
    if request.method == 'POST':
      ...
      if form.is_valid():
        ...
        # messages.success(request, 'Thankyou for registering with us. We have sent you a verification email to your email address[athulyaathu.uk@gmail.com].please verify it.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # gettting the product variations by cartid
                    product_variation = []
                    ...
                    # get the cart items for the user to access his product variations
